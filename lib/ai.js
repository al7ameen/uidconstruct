        ...
        if (res.status === 429) {
            ...
            throw new ProviderRateLimitError(
                byok
                    ...
                    : 'Our free analysis queue is full right now. Try again in about ' + retryAfterSec + ' seconds, or add your own API key below for 60 runs an hour.',
                retryAfterSec
            );
        }
...
async function callAIWithFallback(messages, byok, opts) {
    ...
    throw lastErr || new ProviderRateLimitError('Our free analysis queue is full right now. Try again in a moment, or add your own API key below for 60 runs an hour.', 30);
}
